...
class Task {
    ...
    public function submitTask($id, $task_type, $description, $image_url) {
        $query = "INSERT INTO tasks (id, task_type, description, image_url, userID) VALUES (:id, :task_type, :description, :image_url, :userID)";
